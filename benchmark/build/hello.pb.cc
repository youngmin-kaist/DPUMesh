...
static void InitDefaultsscc_info_HelloRequest_hello_2eproto() {
  ...
  {
    void* ptr = &::dpumesh::bench::_HelloRequest_default_instance_;
    new (ptr) ::dpumesh::bench::HelloRequest();
    ::PROTOBUF_NAMESPACE_ID::internal::OnShutdownDestroyMessage(ptr);
  }
  ::dpumesh::bench::HelloRequest::InitAsDefaultInstance();
}
...
const ::PROTOBUF_NAMESPACE_ID::uint32 TableStruct_hello_2eproto::offsets[] PROTOBUF_SECTION_VARIABLE(protodesc_cold) = {
  ~0u,  // no _has_bits_
  PROTOBUF_FIELD_OFFSET(::dpumesh::bench::HelloRequest, _internal_metadata_),
  ~0u,  // no _extensions_
  ~0u,  // no _oneof_case_
  ~0u,  // no _weak_field_map_
  PROTOBUF_FIELD_OFFSET(::dpumesh::bench::HelloRequest, id_),
  PROTOBUF_FIELD_OFFSET(::dpumesh::bench::HelloRequest, name_),
  PROTOBUF_FIELD_OFFSET(::dpumesh::bench::HelloRequest, scores_),
};
static const ::PROTOBUF_NAMESPACE_ID::internal::MigrationSchema schemas[] PROTOBUF_SECTION_VARIABLE(protodesc_cold) = {
  { 0, -1, sizeof(::dpumesh::bench::HelloRequest)},
};

static ::PROTOBUF_NAMESPACE_ID::Message const * const file_default_instances[] = {
  reinterpret_cast<const ::PROTOBUF_NAMESPACE_ID::Message*>(&::dpumesh::bench::_HelloRequest_default_instance_),
};

const char descriptor_table_protodef_hello_2eproto[] PROTOBUF_SECTION_VARIABLE(protodesc_cold) =
  "\n\013hello.proto\022\rdpumesh.bench\"<\n\014HelloReq"
  "uest\022\n\n\002id\030\001 \001(\004\022\014\n\004name\030\002 \001(\t\022\022\n\006scores"
  "\030\003 \003(\rB\002\020\001b\006proto3"
  ;
...
const ::PROTOBUF_NAMESPACE_ID::internal::DescriptorTable descriptor_table_hello_2eproto = {
  false, false, descriptor_table_protodef_hello_2eproto, "hello.proto", 98,
...
HelloRequest::HelloRequest(::PROTOBUF_NAMESPACE_ID::Arena* arena)
  ...
  // @@protoc_insertion_point(arena_constructor:dpumesh.bench.HelloRequest)
}
HelloRequest::HelloRequest(const HelloRequest& from)
  ...
  id_ = from.id_;
  // @@protoc_insertion_point(copy_constructor:dpumesh.bench.HelloRequest)
}
...
HelloRequest::~HelloRequest() {
  // @@protoc_insertion_point(destructor:dpumesh.bench.HelloRequest)
  SharedDtor();
...
// @@protoc_insertion_point(message_clear_start:dpumesh.bench.HelloRequest)
    ...
    switch (tag >> 3) {
      ...
      case 2:
        if (PROTOBUF_PREDICT_TRUE(static_cast<::PROTOBUF_NAMESPACE_ID::uint8>(tag) == 18)) {
          ...
          CHK_(::PROTOBUF_NAMESPACE_ID::internal::VerifyUTF8(str, "dpumesh.bench.HelloRequest.name"));
          CHK_(ptr);
        } else goto handle_unusual;
        continue;
...
::PROTOBUF_NAMESPACE_ID::uint8* HelloRequest::_InternalSerialize(
  ...
  // @@protoc_insertion_point(serialize_to_array_start:dpumesh.bench.HelloRequest)
  ::PROTOBUF_NAMESPACE_ID::uint32 cached_has_bits = 0;
  (void) cached_has_bits;
  ...
  if (this->name().size() > 0) {
    ::PROTOBUF_NAMESPACE_ID::internal::WireFormatLite::VerifyUtf8String(
      ...
      "dpumesh.bench.HelloRequest.name");
  ...
  // @@protoc_insertion_point(serialize_to_array_end:dpumesh.bench.HelloRequest)
  return target;
}

size_t HelloRequest::ByteSizeLong() const {
// @@protoc_insertion_point(message_byte_size_start:dpumesh.bench.HelloRequest)
  size_t total_size = 0;
...
// @@protoc_insertion_point(generalized_merge_from_start:dpumesh.bench.HelloRequest)
  GOOGLE_DCHECK_NE(&from, this);
  const HelloRequest* source =
      ::PROTOBUF_NAMESPACE_ID::DynamicCastToGenerated<HelloRequest>(
          &from);
  if (source == nullptr) {
  // @@protoc_insertion_point(generalized_merge_from_cast_fail:dpumesh.bench.HelloRequest)
    ::PROTOBUF_NAMESPACE_ID::internal::ReflectionOps::Merge(from, this);
  } else {
  // @@protoc_insertion_point(generalized_merge_from_cast_success:dpumesh.bench.HelloRequest)
    MergeFrom(*source);
  }
}

void HelloRequest::MergeFrom(const HelloRequest& from) {
// @@protoc_insertion_point(class_specific_merge_from_start:dpumesh.bench.HelloRequest)
  GOOGLE_DCHECK_NE(&from, this);
  _internal_metadata_.MergeFrom<::PROTOBUF_NAMESPACE_ID::UnknownFieldSet>(from._internal_metadata_);
  ::PROTOBUF_NAMESPACE_ID::uint32 cached_has_bits = 0;
  (void) cached_has_bits;
...
// @@protoc_insertion_point(generalized_copy_from_start:dpumesh.bench.HelloRequest)
  if (&from == this) return;
  Clear();
  MergeFrom(from);
}
...
// @@protoc_insertion_point(class_specific_copy_from_start:dpumesh.bench.HelloRequest)
  if (&from == this) return;
  Clear();
  MergeFrom(from);
}
...
template<> PROTOBUF_NOINLINE ::dpumesh::bench::HelloRequest* Arena::CreateMaybeMessage< ::dpumesh::bench::HelloRequest >(Arena* arena) {
  return Arena::CreateMessageInternal< ::dpumesh::bench::HelloRequest >(arena);
}
